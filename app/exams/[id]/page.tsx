    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          { id: 'b', text: 'A function that has access to outer scope variables' },
...
export default function ExamPage({ params }: ExamPageProps) {
  ...
  const [exam, setExam] = useState<typeof mockExams['1'] | null>(null);
  ...
  const handleSave = async (answers: any[]) => {
    try {
